...
def evaluate_regression_baseline(
    ...
    return evaluate_model(model=model, X_test=X_test, y_test=y_test, problem_type="regression")
...
def evaluate_classification_baseline(
    ...
    model.fit(X_train, y_train)
    return evaluate_model(model=model, X_test=X_test, y_test=y_test, problem_type="classification")
